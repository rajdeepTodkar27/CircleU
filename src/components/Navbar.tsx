...
function Navbar() {
  ...
  return (
    <div className="flex justify-between ">
      <div className="flex flex-1 justify-between  items-center bg-gradient-to-tl from-purple-700 to-purple-400 p-3 text-lg  ">
        ...
        <h2 className="sm:flex  hidden  items-center gap-5">
          <SignedIn >
            <button title="Contact us" onClick={() => router.push("/dashboard/Groups")}>Groups</button>
